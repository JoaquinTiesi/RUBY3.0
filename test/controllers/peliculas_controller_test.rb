...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference("Pelicula.count") do
      post peliculas_url, params: { pelicula: { calificacion: @pelicula.calificacion, fechacreacion: @pelicula.fechacreacion, genero_id: @pelicula.genero_id, titulo: @pelicula.titulo } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { calificacion: @pelicula.calificacion, fechacreacion: @pelicula.fechacreacion, genero_id: @pelicula.genero_id, titulo: @pelicula.titulo } }
