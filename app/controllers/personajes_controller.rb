class PersonajesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @personaje.save
        format.html { redirect_to personaje_url(@personaje), notice: "Personaje was successfully created." }
  ...
  def update
    respond_to do |format|
      if @personaje.update(personaje_params)
        format.html { redirect_to personaje_url(@personaje), notice: "Personaje was successfully updated." }
  ...
  private
    ...
    def personaje_params
      params.require(:personaje).permit(:nombre, :edad, :peso, :hisoria)
    end
end
